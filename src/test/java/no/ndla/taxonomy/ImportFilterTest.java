...
public class ImportFilterTest {
    ...
    public void can_import_filter() {
        ...
        FilterIndexDocument[] result = restTemplate.getForObject(BASE_URL + "/v1/resources/" + resource.getId() + "/filters", FilterIndexDocument[].class);
        ...
        RelevanceIndexDocument[] relevances = restTemplate.getForObject(BASE_URL + "/v1/relevances", RelevanceIndexDocument[].class);
        ...
        no.ndla.taxonomy.client.subjects.FilterIndexDocument[] subjectFilters = restTemplate.getForObject(BASE_URL + "/v1/subjects/" + subject.getId() + "/filters", no.ndla.taxonomy.client.subjects.FilterIndexDocument[].class);
        ...
        no.ndla.taxonomy.client.subjects.FilterIndexDocument[] topicFilters = restTemplate.getForObject(BASE_URL + "/v1/topics/" + topic.getId() + "/filters", no.ndla.taxonomy.client.subjects.FilterIndexDocument[].class);
